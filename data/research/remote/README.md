...
Snapshots use a semantic fingerprint so repeated daily observations with no normalized content change preserve the existing dated file and complete through the workflow's no-change path.
